...
@Epic("Проверка блока онлайн пополнения без комиссии")
@Story("Тесты формы пополнения")
public class OnlineReplenishmentTests {
    ...
    @Test
    @Description("Проверка отображения заголовка блока онлайн пополнения без комиссии")
    ...
    @Test
    @Description("Проверка наличия и отображения логотипов платёжных систем в блоке пополнения")
    ...
    @Test
    @Description("Проверка отображения ссылки 'Подробнее о сервисе' и её кликабельности")
    ...
    @Test
    @Description("Заполнение формы пополнения и проверка доступности кнопки 'Продолжить'")
    ...
    @Test
    @Description("Проверка наличия и корректности placeholder'ов для различных вариантов пополнения")
    ...
    @Test
    @Description("Заполнение формы пополнения, проверка суммы, номера телефона и отображения иконок платежных систем")
